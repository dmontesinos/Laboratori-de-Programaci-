...
public:
	...
	bool importComanda(const string& nomClient, Data& data, float &import);
	bool DetallProducteComanda(const string& nomClient, Data& data, const string& codiProducte, int& nUnitats, float& preu);
