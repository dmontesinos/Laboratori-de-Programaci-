...
int main()
{
	...
	try
	{
		...
		cout << "Comment :=>> ==============================================" << endl;
		cout << "Comment :=>> CREANT GRAF EPINIONS.........................." << endl;
		Graph gEpi(nomFitxerEpi);

		cout << "Comment :=>> ==========================================" << endl;
		cout << "Comment :=>> CALCULANT COMUNITATS EPINIONS............." << endl;
		cout << "Comment :=>> ==========================================" << endl;
		list<Tree<double>*> listDendrogramsEpi;
		gEpi.calculaComunitats(listDendrogramsEpi);

		cout << "Comment :=>> ==========================================" << endl;
		cout << "Comment :=>> ESCRIVINT COMUNITATS EPINIONS............." << endl;
		cout << "Comment :=>> ==========================================" << endl;
		ofstream fCOMEpi, fCOMEpiOK;
		fCOMEpi.open("0COMEpi.txt");
		if (fCOMEpi.is_open())
		{
			list<Tree<double>*>::iterator itAnt;
			list<Tree<double>*>::iterator it;
			it = listDendrogramsEpi.begin();
			while (it != listDendrogramsEpi.end())
			{
				fCOMEpi << (*(*it)) << endl;
				itAnt = it;
				it++;
				listDendrogramsEpi.erase(itAnt);
			}

			fCOMEpi.close();
		}

		if (IgualFitxers("0COMEpi.txt", "0COMEpiOK.txt", "0COMEpiComp.txt"))
		{
			cout << "Comment :=>> COMUNITATS EPINIONS CALCULAT OK .............." << endl;
			grade += 5;
		}
		else
		{
			cout << "Comment :=>> COMUNITATS EPINIONS CALCULAT ERROR............" << endl;
			valid = false;
		}
		gEpi.clear();

		cout << endl << "Comment :=>> GRADE Parcial: " << grade << "(Sobre 30)" << endl << endl;
