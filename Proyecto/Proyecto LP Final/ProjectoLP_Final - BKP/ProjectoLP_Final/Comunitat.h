...
private:
	...
	//Cada node fulla te el index del node, cada node intern i l'arrel te el deltaQij que l'ha fet unir-se. 
	//Si es negatiu vol dir que no hauriem de fer aquesta unio
